...
<head>
  ...
  <title>Smita Pandey — Full-Stack Web Developer</title>
  <meta name="description" content="Portfolio of Smita Pandey, a Full-Stack Web Developer skilled in HTML, CSS, JavaScript, and PHP. Explore projects, services, and contact details." />
  <meta name="author" content="Smita Pandey" />
  <meta name="keywords" content="Smita Pandey, full stack developer, web developer, portfolio, HTML CSS JavaScript PHP, CampusXchange" />
  ...
  <i class="fa-solid fa-bars"></i>
    ...
    <main id="home" class="hero">
      <div class="card intro fade-up">
        <h2>Hi, I'm <span style="color:var(--primary);font-weight:800">Smita Pandey</span></h2>
        <p>I'm a full-stack web developer who builds fast, accessible, and beautiful web experiences. I enjoy turning complex problems into simple, elegant solutions — from pixel-perfect UIs to robust backend services.</p>
      ...
      <aside class="profile card fade-up">
        <div class="avatar"> <img src="images/Me.jpeg"> </div>
        <div class="meta">
          <strong>Smita Pandey </strong>
          <small class="muted">Full-stack developer</small>
        </div>
        ...
        <div style="width:100%;display:flex;gap:8px;justify-content:space-between">
          ...
          <a class="btn secondary" style="flex:1;justify-content:center;color: white;" href="#projects"><i class="fa-solid fa-code"></i> Projects</a>
        </div>
      </aside>
    </main>
        ...
        <div class="facts">
          <div class="fact">
            <div>
              ...
              <div class="muted">Gopalganj(Bihar), India</div>
            </div>
          ...
          <div class="fact">
            <div>
              ...
              <div class="muted" style="font-size: 12px;">smitabsccs@gmail.com</div>
            </div>
    ...
    <section id="skills">
      ...
      <div class="skills">
        ...
        <div class="skill card fade-up">
          ...
          <div class="muted">•PHP •MySQL</div>
          <div class="bar"><i data-percent="80"></i></div>
        </div>

        <div class="skill card fade-up">
          <strong>Tools & DevOps</strong>
          <div class="muted">GitHub •Vscode</div>
          <div class="bar"><i data-percent="70"></i></div>
        </div>

        <div class="skill card fade-up">
          <strong>Others</strong>
          <div class="muted">• Generative AI • C++ </div>
